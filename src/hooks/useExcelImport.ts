      ...
      try {
        ...
        if (dataType === 'export') {
          const importedRecords: TrackingRecord[] = jsonData.map(
            ...
            dropDone: String(row.dropDone || 'No'),
            dropDate: String(row.dropDate || ''),
            returnNeeded: String(row.returnNeeded || 'No'),
            ...
            titlesDispatched: String(row.titlesDispatched || 'N/A'),
            validatedFwd: Boolean(row.validatedFwd),
            titlesReturned: String(row.titlesReturned || 'N/A'),
          ...
          const importedRecords: ImportTrackingRecord[] = jsonData.map(
            ...
            delivered: String(row.delivered || 'No'),
            returned: String(row.returned || 'No'),
