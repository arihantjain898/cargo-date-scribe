          ...
          <table className="w-full border-collapse text-xs">
            <thead className="sticky top-0 bg-white z-30 shadow-sm">
              <tr className="border-b-2 border-gray-500">
                <th className="border-r-2 border-gray-500 p-1.5 text-center font-bold text-gray-900 bg-gray-100 w-10">
                  <Checkbox
                ...
                <th className="border-r-2 border-gray-500 p-1.5 text-center font-bold text-gray-900 bg-gray-100 w-12">
                  Actions
                </th>
                ...
                <th className="border-r-2 border-gray-500 p-1.5 text-left font-bold text-gray-900 bg-blue-100 min-w-[90px]">Work Order #</th>
                <th colSpan={4} className="border-r-2 border-gray-500 p-1.5 text-center font-bold text-gray-900 bg-emerald-100">
                  Drop / Return
                </th>
                <th colSpan={4} className="border-r-2 border-gray-500 p-1.5 text-center font-bold text-gray-900 bg-purple-100">
                  Documents
                </th>
                <th colSpan={3} className="border-r-2 border-gray-500 p-1.5 text-center font-bold text-gray-900 bg-orange-100">
                  Titles
                </th>
                <th colSpan={3} className="border-r-2 border-gray-500 p-1.5 text-center font-bold text-gray-900 bg-pink-100">
                  Invoicing
                </th>
                <th colSpan={2} className="border-r-2 border-gray-500 p-1.5 text-center font-bold text-gray-900 bg-yellow-100">
                  Payment
                </th>
                <th colSpan={3} className="border-r-2 border-gray-500 p-1.5 text-center font-bold text-gray-900 bg-red-100">
                  Final Steps
                </th>
              ...
              <tr className="bg-white border-b-2 border-gray-400 sticky top-8 z-30">
                <th className="border-r-2 border-gray-400 p-1 text-center text-xs font-semibold text-gray-700 bg-gray-50 w-10">Select</th>
                <th className="border-r-2 border-gray-400 p-1 text-center text-xs font-semibold text-gray-700 bg-gray-50 w-12">Delete</th>
                ...
                <th className="border-r-2 border-gray-400 p-1 text-left text-xs font-semibold text-gray-700 bg-blue-50 min-w-[90px]">Work Order #</th>
                ...
                <th className="border-r-2 border-gray-400 p-1 text-left text-xs font-semibold text-gray-700 bg-emerald-50 min-w-[90px]">Return Date</th>
                ...
                <th className="border-r-2 border-gray-400 p-1 text-left text-xs font-semibold text-gray-700 bg-purple-50 min-w-[110px]">Doc Cutoff Date</th>
                ...
                <th className="border-r-2 border-gray-400 p-1 text-center text-xs font-semibold text-gray-700 bg-orange-50 min-w-[100px]">Titles Returned</th>
                ...
                <th className="border-r-2 border-gray-400 p-1 text-center text-xs font-semibold text-gray-700 bg-pink-50 min-w-[120px]">Transphere Inv. Sent</th>
                ...
                <th className="border-r-2 border-gray-400 p-1 text-center text-xs font-semibold text-gray-700 bg-yellow-50 min-w-[70px]">SSL Paid</th>
                ...
                <th className="border-r-2 border-gray-400 p-1 text-center text-xs font-semibold text-gray-700 bg-red-50 min-w-[120px]">Docs Sent to Customer</th>
                <th className="p-1 text-left text-xs font-semibold text-gray-700 bg-gray-50 min-w-[100px]">Notes</th>
              </tr>
            </thead>
            <tbody>
              {data.map((record, index) => (
                <tr key={record.id} className={`border-b border-gray-300 hover:bg-blue-25 transition-all duration-200 ${
                  ...
                  <td className="border-r border-gray-300 p-0.5">{renderCell(record, 'customer')}</td>
                  <td className="border-r border-gray-300 p-0.5">{renderCell(record, 'ref')}</td>
                  <td className="border-r border-gray-300 p-0.5">{renderCell(record, 'file')}</td>
                  <td className="border-r border-gray-300 p-0.5">{renderCell(record, 'workOrder')}</td>
                  <td className="border-r border-gray-300 p-0.5">{renderCell(record, 'dropDone', true)}</td>
                  <td className="border-r border-gray-300 p-0.5">{renderCell(record, 'dropDate', false, true)}</td>
                  <td className="border-r border-gray-300 p-0.5">{renderCell(record, 'returnNeeded', true)}</td>
                  <td className="border-r border-gray-300 p-0.5">{renderCell(record, 'returnDate', false, true)}</td>
                  <td className="border-r border-gray-300 p-0.5">{renderCell(record, 'docsSent', true)}</td>
                  <td className="border-r border-gray-300 p-0.5">{renderCell(record, 'docsReceived', true)}</td>
                  <td className="border-r border-gray-300 p-0.5">{renderCell(record, 'aesMblVgmSent', true)}</td>
                  <td className="border-r border-gray-300 p-0.5">{renderCell(record, 'docCutoffDate', false, true)}</td>
                  <td className="border-r border-gray-300 p-0.5">{renderCell(record, 'titlesDispatched', true)}</td>
                  <td className="border-r border-gray-300 p-0.5">{renderCell(record, 'validatedFwd', true)}</td>
                  <td className="border-r border-gray-300 p-0.5">{renderCell(record, 'titlesReturned', true)}</td>
                  <td className="border-r border-gray-300 p-0.5">{renderCell(record, 'sslDraftInvRec', true)}</td>
                  <td className="border-r border-gray-300 p-0.5">{renderCell(record, 'draftInvApproved', true)}</td>
                  <td className="border-r border-gray-300 p-0.5">{renderCell(record, 'transphereInvSent', true)}</td>
                  <td className="border-r border-gray-300 p-0.5">{renderCell(record, 'paymentRec', true)}</td>
                  <td className="border-r border-gray-300 p-0.5">{renderCell(record, 'sslPaid', true)}</td>
                  <td className="border-r border-gray-300 p-0.5">{renderCell(record, 'insured', true)}</td>
                  <td className="border-r border-gray-300 p-0.5">{renderCell(record, 'released', true)}</td>
                  <td className="border-r border-gray-300 p-0.5">{renderCell(record, 'docsSentToCustomer', true)}</td>
