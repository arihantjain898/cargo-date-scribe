          ...
          <table className="w-full border-collapse">
            <thead className="sticky top-0 bg-white z-20">
              <tr>
                ...
                <th colSpan={4} className="border-r border-gray-200 p-3 text-center font-medium text-gray-700 bg-blue-50">
                  Project Information
                </th>
              ...
              <tr className="bg-white border-b border-gray-200">
                <th className="border-r border-gray-200 p-2 text-center text-xs font-medium text-gray-600 bg-gray-25 w-16">Delete</th>
                <th className="border-r border-gray-200 p-2 text-left text-xs font-medium text-gray-600 bg-blue-25 min-w-[100px]">Customer</th>
