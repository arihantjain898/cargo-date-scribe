          ...
          <table className="w-full border-collapse text-xs">
            <thead className="sticky top-0 bg-white z-30 shadow-sm">
              ...
              <tr className="bg-gray-200 border-b-4 border-gray-500 sticky top-[41px] z-30">
                ...
                <th className="border-l-4 border-black border-r border-gray-500 p-1 text-left text-xs font-bold text-gray-800 bg-gray-200 min-w-[100px]">Bond</th>
              ...
              {data.map((record, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="border-l-4 border-black border-r border-gray-500 p-1">{renderCell(record, 'bond')}</td>
