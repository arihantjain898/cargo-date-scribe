...
interface FreightTrackerWithLocalStorageProps {
  useLocalStorage: boolean;
}

const FreightTrackerWithLocalStorage = ({ useLocalStorage }: FreightTrackerWithLocalStorageProps) => {
  ...
  }, [allFilesData, importTrackingData, exportTrackingData, domesticTruckingData, useLocalStorage]);
...
export default FreightTrackerWithLocalStorage;
